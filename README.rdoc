...
11. Run the Socky Websockets server by executing this command in the project folder:
    jruby -S socky -c socky_server.yml
12. Open the browser at http://localhost:8080, signup and you will see the Geograph map.