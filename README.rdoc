...
8. Install the agent-farm (see here[https://github.com/algorithmica/geograph-agent-farm])
9. Run TorqueBox from the geograph folder:
    ./scripts/dev_launch.sh
10. Open the browser at http://madmass-node:8080, signup and you will see the Geograph map.