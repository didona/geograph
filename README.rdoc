...
1. Install TorqueBox v2.0.0.beta3 (download it here[http://torquebox.org/release/org/torquebox/torquebox-dist/2.0.0.beta3/torquebox-dist-2.0.0.beta3-bin.zip] and follow these[http://torquebox.org/documentation/current/installation.html] instructions).
